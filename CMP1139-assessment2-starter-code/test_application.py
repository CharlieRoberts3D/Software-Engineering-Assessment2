...
(Many more tests should be used
no need to add tests for the provided code
but you may wish to add test to help you develop/test the code you add.)
"""
import appointment
...
def test_appointments():
    """
    NOTE: You could add a similar test
    for checking your decorated appointment works
    """
    pet = setup()  # creates a pet
    # overrides the input() function within the appointment.py file.
    appointment.input = lambda: "input"

    # <-- change below line to test your appointment code
    ...
    # assert notes == ['weight= input', 'input',
    #                  'vaccination = input', 'vaccination = input',
    #                  'surgery= input']
